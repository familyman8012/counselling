...
const QuillEditor = (props) => {
  ...
  //useSwr
  //const { swrdata, mutate } = useSwrFetch("/api/post/post");
  ...
  const createItem = useCallback(() => {
    ...
    //axios.post("/api/post/post", variables);
  ...
  const modifyItem = (p_id) => {
    ...
    useSwrCrud(
      "put",
      "/api/post/post",
      { p_id, username, title, cont },
      swrdata,
      mutate
    );
    mutate(`/api/post/post?category=${category}`);
    router.back();
    router.back();
  };
    ...
    <>
      <div className="wrap_write_head">
        ...
        <span className="box_btn">
          <span class="btn btn_cancel" onClick={goList}>
            취소
          </span>
          {category === "글수정" ? (
            <span class="btn btn_save" onClick={() => modifyItem(p_id)}>
              수정
            </span>
          ) : (
            <span class="btn btn_save" onClick={createItem}>
              작성
            </span>
          )}
        </span>
